...
printf "\n with commit message, see Changelong: https://github.com/komuw/clog/blob/master/CHANGELOG.md \n" && \
  git tag -a "${VERSION}" -m "see Changelong: https://github.com/komuw/clog/blob/master/CHANGELOG.md"
