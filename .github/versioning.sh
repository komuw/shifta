...
printf "\n with commit message, see Changelong: https://github.com/komuw/clog/blob/main/CHANGELOG.md \n" && \
  git tag -a "${VERSION}" -m "see Changelong: https://github.com/komuw/clog/blob/main/CHANGELOG.md"
